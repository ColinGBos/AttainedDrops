...
{
	/*
	 * Blazerod, enderpearl, gunpowder, bone, spider eye, string, ghast tear,
	 * rotten flesh, slimeball
	 */
	...
	public static int[] sproutRateDefault =
	{ 16, 20, 12, 12, 16, 16, 24, 8, 12 };
	...
	public static int ParticleRateDefault[] =
	{ 3, 2, 10, 6, 5, 7, 4, 16, 10 };
